...
<head>
  <meta charset="UTF-8">
    ...
    <title>OVERCLOCK/TECH — <?= htmlspecialchars($product['name']) ?></title>
    <meta name="description" content="OVERCLOCK/TECH — View product">    
    ...
    <div class="product-details">
      ...
      <div class="product-info">
        ...
        <form method="POST" action="product.php?id=<?= $product['product_id'] ?>">
          ...
          <button type="submit" name="add_to_cart" class="btn btn-primary"> <i class="fa fa-shopping-cart"></i> Add to Cart</button>
        </form>
